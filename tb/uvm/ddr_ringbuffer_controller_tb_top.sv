...
// UVM top-level testbench wrapper for the standalone DDR ring-buffer controller.
module ddr_ringbuffer_controller_tb_top;
  ...
  initial begin
    uvm_config_db#(virtual axis_stream_if #(AXIS_DATA_W, AXIS_USER_W))::set(null, "*", "src_vif",
                                                                            s_axis_if);
    uvm_config_db#(virtual axis_stream_if #(AXI_DATA_W, RD_AXIS_USER_W))::set(null, "*", "rd_vif",
                                                                              m_axis_rd_if);
