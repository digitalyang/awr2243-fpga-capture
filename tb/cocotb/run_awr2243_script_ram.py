...
BUILD_ROOT = REPO_ROOT / "sim_build" / "awr2243_script_ram_cocotb"
TOPLEVEL = "awr2243_script_ram_cocotb_top"
TEST_MODULE = "awr2243_script_ram_cocotb"

ALL_TESTS = [
    "test_metadata_and_sync_read",
    "test_same_cycle_write_read_bypass",
]
...
def build_sources():
    return [
        ...
        TB_DIR / "awr2243_script_ram_cocotb_top.sv",
    ]
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run Verilator+cocotb regression for awr2243_script_ram"
    )
    parser.add_argument(
        "--testcase",
        action="append",
