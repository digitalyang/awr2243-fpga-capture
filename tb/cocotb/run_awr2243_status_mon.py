...
BUILD_ROOT = REPO_ROOT / "sim_build" / "awr2243_status_mon_cocotb"
TOPLEVEL = "awr2243_status_mon_cocotb_top"
TEST_MODULE = "awr2243_status_mon_cocotb"

ALL_TESTS = [
    "test_reset_defaults",
    "test_irq_capture_and_clear",
    "test_fault_capture_and_live_clear",
    "test_arm_masks_prearm_history",
    "test_warm_reset_capture",
]
...
def build_sources():
    return [
        ...
        TB_DIR / "awr2243_status_mon_cocotb_top.sv",
    ]
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run Verilator+cocotb regression for awr2243_status_mon"
    )
    parser.add_argument(
        "--testcase",
        action="append",
