...
BUILD_ROOT = REPO_ROOT / "sim_build" / "awr2243_cmd_fetch_cocotb"
TOPLEVEL = "awr2243_cmd_fetch_cocotb_top"
TEST_MODULE = "awr2243_cmd_fetch_cocotb"

ALL_TESTS = [
    "test_linear_fetch_and_done",
    "test_relative_jump",
]
...
def build_sources():
    return [
        ...
        TB_DIR / "awr2243_cmd_fetch_cocotb_top.sv",
    ]
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run Verilator+cocotb regression for awr2243_cmd_fetch"
    )
    parser.add_argument(
        "--testcase",
        action="append",
