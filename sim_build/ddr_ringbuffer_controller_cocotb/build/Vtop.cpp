...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , slot_start_i{vlSymsp->TOP.slot_start_i}
    , slot_done_i{vlSymsp->TOP.slot_done_i}
    , slot_valid_good_i{vlSymsp->TOP.slot_valid_good_i}
    , slot_overflow_err_i{vlSymsp->TOP.slot_overflow_err_i}
    ...
    , dbg_wr_burst_beats_o{vlSymsp->TOP.dbg_wr_burst_beats_o}
    , dbg_wr_burst_sent_o{vlSymsp->TOP.dbg_wr_burst_sent_o}
    , s_axis_slot_tvalid{vlSymsp->TOP.s_axis_slot_tvalid}
    , s_axis_slot_tready{vlSymsp->TOP.s_axis_slot_tready}
    , s_axis_slot_tlast{vlSymsp->TOP.s_axis_slot_tlast}
    ...
    , slot_seq_i{vlSymsp->TOP.slot_seq_i}
    ...
    , slot_bytes_i{vlSymsp->TOP.slot_bytes_i}
    ...
    , s_axis_slot_tdata{vlSymsp->TOP.s_axis_slot_tdata}
    , s_axis_slot_tkeep{vlSymsp->TOP.s_axis_slot_tkeep}
    ...
    , s_axis_slot_tuser{vlSymsp->TOP.s_axis_slot_tuser}
    ...
    , __PVT__ddr_ringbuffer_controller_cocotb_top__DOT__s_axis_slot_if{vlSymsp->TOP.__PVT__ddr_ringbuffer_controller_cocotb_top__DOT__s_axis_slot_if}
    , __PVT__ddr_ringbuffer_controller_cocotb_top__DOT__m_axis_rd_if{vlSymsp->TOP.__PVT__ddr_ringbuffer_controller_cocotb_top__DOT__m_axis_rd_if}
    , __PVT__ddr_ringbuffer_controller_cocotb_top__DOT__m_axi_if{vlSymsp->TOP.__PVT__ddr_ringbuffer_controller_cocotb_top__DOT__m_axi_if}
    , rootp{&(vlSymsp->TOP)}
{
...
VL_ATTR_COLD void Vtop::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    ...
    stfp->spTrace()->addInitCb(&trace_init, &(vlSymsp->TOP), name(), false, 829);
