...
class alignas(VL_CACHE_LINE_BYTES) Vtop VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    Vtop_csi_packet_pkg* const __PVT__csi_packet_pkg;
    Vtop_slot_packer_pkg* const __PVT__slot_packer_pkg;
    Vtop_ddr_ringbuffer_pkg* const __PVT__ddr_ringbuffer_pkg;
    Vtop_axis_stream_if* const __PVT__pipeline_cocotb_top__DOT__s_axis_if;
    Vtop_axis_stream_if* const __PVT__pipeline_cocotb_top__DOT__pkt_axis_if;
    Vtop_axis_stream_if* const __PVT__pipeline_cocotb_top__DOT__slot_axis_if;
    Vtop_axis_stream_if* const __PVT__pipeline_cocotb_top__DOT__m_axis_rd_if;
    Vtop_axi4_mm_if* const __PVT__pipeline_cocotb_top__DOT__m_axi_if;
