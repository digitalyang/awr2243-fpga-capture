...
class alignas(VL_CACHE_LINE_BYTES) Vtop VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    Vtop_axis_stream_if* const __PVT__fixed_slot_packer_cocotb_top__DOT__s_axis_if;
    Vtop_axis_stream_if* const __PVT__fixed_slot_packer_cocotb_top__DOT__m_axis_if;
