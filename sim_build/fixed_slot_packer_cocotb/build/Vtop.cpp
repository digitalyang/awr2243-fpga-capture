...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , pkt_start_i{vlSymsp->TOP.pkt_start_i}
    , pkt_done_i{vlSymsp->TOP.pkt_done_i}
    , pkt_crc_err_i{vlSymsp->TOP.pkt_crc_err_i}
    , pkt_ecc_err_i{vlSymsp->TOP.pkt_ecc_err_i}
    , pkt_trunc_err_i{vlSymsp->TOP.pkt_trunc_err_i}
    , pkt_valid_good_i{vlSymsp->TOP.pkt_valid_good_i}
    ...
    , pkt_bytes_i{vlSymsp->TOP.pkt_bytes_i}
    , pkt_seq_i{vlSymsp->TOP.pkt_seq_i}
    ...
    , __PVT__fixed_slot_packer_cocotb_top__DOT__s_axis_if{vlSymsp->TOP.__PVT__fixed_slot_packer_cocotb_top__DOT__s_axis_if}
    , __PVT__fixed_slot_packer_cocotb_top__DOT__m_axis_if{vlSymsp->TOP.__PVT__fixed_slot_packer_cocotb_top__DOT__m_axis_if}
    , rootp{&(vlSymsp->TOP)}
{
...
VL_ATTR_COLD void Vtop::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    ...
    stfp->spTrace()->addInitCb(&trace_init, &(vlSymsp->TOP), name(), false, 228);
