module awr2243_status_mon #(
  ...
  localparam int unsigned NERROR_FILTER_LEN = (NERROR_FILTER_CYCLES < 1) ? 1 : NERROR_FILTER_CYCLES;
  ...
  localparam int unsigned NERROR_FILTER_CNT_W = (NERROR_FILTER_LEN <= 1) ? 1 : $clog2(
      NERROR_FILTER_LEN
  );
  localparam int unsigned WARM_RESET_FILTER_CNT_W = (WARM_RESET_FILTER_LEN <= 1) ? 1 : $clog2(
      WARM_RESET_FILTER_LEN
  );
